...
import consulo.maven.rt.m3.common.server.Maven3ServerEmbedder;
import consulo.maven.rt.m3.common.server.Maven3ServerGlobals;
import consulo.maven.rt.m3.common.server.Maven3ServerIndexerImpl;
    ...
    try {
      Maven3ServerIndexerImpl result = new Maven3ServerIndexerImpl(new Maven32ServerEmbedderImpl(new MavenServerSettings())) {
        ...
        public Maven3ServerEmbedder createEmbedder(MavenServerSettings settings) throws RemoteException {
          return new Maven32ServerEmbedderImpl(settings);
        }
      };
      UnicastRemoteObject.exportObject(result, 0);
      return result;
