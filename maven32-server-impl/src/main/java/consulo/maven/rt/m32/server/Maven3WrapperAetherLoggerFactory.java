...
import consulo.maven.rt.m3.common.server.Maven3ServerConsoleLogger;
...
class Maven3WrapperAetherLoggerFactory implements LoggerFactory
{
	...
	public Maven3WrapperAetherLoggerFactory(final Maven3ServerConsoleLogger consoleWrapper)
	{
