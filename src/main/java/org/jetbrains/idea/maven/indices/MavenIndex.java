...
public class MavenIndex
{
	...
	public MavenIndex(MavenIndexerWrapper nexusIndexer, File dir, String repositoryId, String repositoryPathOrUrl, Kind kind, IndexListener listener) throws MavenIndexException
	{
