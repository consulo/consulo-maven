...
public class MavenId implements Serializable, MavenCoordinate
{
	...
	public MavenId(@Nullable String groupId, @Nullable String artifactId)
	{
	...
	{
		if(myArtifactId != null ? !myArtifactId.equals(artifactId) : artifactId != null)
		{
			return false;
		}
		if(myGroupId != null ? !myGroupId.equals(groupId) : groupId != null)
		{
			return false;
		}
		return true;
	...
	{
		if(!equals(groupId, artifactId))
		{
			return false;
		}
		if(myVersion != null ? !myVersion.equals(version) : version != null)
		{
			return false;
		}
		return true;
