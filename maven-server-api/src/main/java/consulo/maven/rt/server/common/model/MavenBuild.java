...
public class MavenBuild extends MavenBuildBase implements Serializable {
  ...
  private List<MavenSource> myMavenSources;
  ...
  public List<MavenSource> getMavenSources() {
    return myMavenSources == null ? Collections.<MavenSource>emptyList() : myMavenSources;
  }

  public void setMavenSources(List<MavenSource> mavenSources) {
    myMavenSources = new ArrayList<MavenSource>(mavenSources);
  }
}