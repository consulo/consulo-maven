...
import consulo.maven.rt.server.common.util.MavenJDOMUtil;
...
public class MavenPlugin implements Serializable
{
	...
	public boolean equals(Object o)
	{
		...
		if(myDefault != that.myDefault)
		{
			return false;
		}
		if(myExtensions != that.myExtensions)
		{
			return false;
		}
		if(myGroupId != null ? !myGroupId.equals(that.myGroupId) : that.myGroupId != null)
		{
			return false;
		}
		if(myArtifactId != null ? !myArtifactId.equals(that.myArtifactId) : that.myArtifactId != null)
		{
			return false;
		}
		...
		if(myExecutions != null ? !myExecutions.equals(that.myExecutions) : that.myExecutions != null)
		{
			return false;
		}
		if(myDependencies != null ? !myDependencies.equals(that.myDependencies) : that.myDependencies != null)
		{
			return false;
		}
	...
	public static class Execution implements Serializable
	{
		...
		public boolean equals(Object o)
		{
			...
			if(myExecutionId != null ? !myExecutionId.equals(that.myExecutionId) : that.myExecutionId != null)
			{
				return false;
			}
			if(myPhase != null ? !myPhase.equals(that.myPhase) : that.myPhase != null)
			{
				return false;
			}
			if(!MavenJDOMUtil.areElementsEqual(myConfiguration, that.myConfiguration))
