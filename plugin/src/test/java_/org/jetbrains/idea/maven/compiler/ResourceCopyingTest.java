...
public abstract class ResourceCopyingTest extends MavenImportingTestCase
{
	...
	protected void setUpInWriteAction() throws Exception
	{
		...
		consulo.ide.impl.compiler.resourceCompiler.ResourceCompilerConfiguration.getInstance(myProject).addResourceFilePattern("!*.xxx");
		consulo.ide.impl.compiler.resourceCompiler.ResourceCompilerConfiguration.getInstance(myProject).addResourceFilePattern("!*.yyy");
		consulo.ide.impl.compiler.resourceCompiler.ResourceCompilerConfiguration.getInstance(myProject).addResourceFilePattern("!*.zzz");
	}
	...
	public void testCustomResources() throws Exception
	{
		...
		importProject("<groupId>test</groupId>" + "<artifactId>project</artifactId>" + "<version>1</version>" +
				...
				"<build>" + "  <resources>" + "    <resource><directory>res</directory></resource>" + "  </resources>" + "  <testResources>" + "    " +
				"<testResource><directory>testRes</directory></testResource>" + "  </testResources>" + "</build>");
	...
	public void testCustomTargetPath() throws Exception
	{
		...
		importProject("<groupId>test</groupId>" + "<artifactId>project</artifactId>" + "<version>1</version>" +
				...
				"<build>" + "  <resources>" + "    <resource>" + "      <directory>res</directory>" + "      <targetPath>foo</targetPath>" + "    </resource>" + "  </resources>" + "</build>");
	...
	public void testAbsoluteCustomTargetPath() throws Exception
	{
		...
		importProject("<groupId>test</groupId>" + "<artifactId>project</artifactId>" + "<version>1</version>" +
				...
				"<build>" + "  <resources>" + "    <resource>" + "      <directory>res</directory>" + "      <targetPath>${build.directory}/anotherDir</targetPath>" + "    </resource>" + "  " +
				"</resources>" + "</build>");
	...
	public void testMavenSpecifiedPattern() throws Exception
	{
		...
		importProject("<groupId>test</groupId>" + "<artifactId>project</artifactId>" + "<version>1</version>" +
				...
				"<build>" + "  <resources>" + "    <resource>" + "      <directory>res</directory>" + "      <includes>" + "        <include>**/**</include>" + "      </includes>" + "    " +
	...
	public void testMavenSpecifiedPatternEndSlash() throws Exception
	{
		...
		importProject("<groupId>test</groupId>" + "<artifactId>project</artifactId>" + "<version>1</version>" +
				...
				"<build>" + "  <resources>" + "    <resource>" + "      <directory>res</directory>" + "      <includes>" + "        <include>**/</include>" + "      </includes>" + "    </resource>"
				+ "  </resources>" + "</build>");
	...
	public void testIncludesAndExcludes() throws Exception
	{
		...
		importProject("<groupId>test</groupId>" + "<artifactId>project</artifactId>" + "<version>1</version>" +
				...
				"<build>" + "  <resources>" + "    <resource>" + "      <directory>res</directory>" + "      <includes>" + "        <include>**/*.xxx</include>" + "        <include>**/*" +
				".yyy</include>" + "      </includes>" + "      <excludes>" + "        <exclude>*.xxx</exclude>" + "        <exclude>dir/*.yyy</exclude>" + "      </excludes>" + "    </resource>" +
				"  </resources>" + "</build>");
	...
	public void testDoNotCopyIgnoredFiles() throws Exception
	{
		...
		importProject("<groupId>test</groupId>" + "<artifactId>project</artifactId>" + "<version>1</version>" +
				...
				"<build>" + "  <resources>" + "    <resource>" + "      <directory>res</directory>" + "      <includes>" + "        <include>**/*.properties</include>" + "      </includes>" + "    " +
				"</resource>" + "  </resources>" + "</build>");
	...
	public void testDeletingFilesThatWasCopiedAndThenDeleted() throws Exception
	{
		...
		importProject("<groupId>test</groupId>" + "<artifactId>project</artifactId>" + "<version>1</version>" +
				...
				"<build>" + "  <resources>" + "    <resource>" + "      <directory>res</directory>" + "    </resource>" + "  </resources>" + "</build>");
	...
	public void testDeletingFilesThatWasCopiedAndThenExcluded() throws Exception
	{
		...
		createProjectPom("<groupId>test</groupId>" + "<artifactId>project</artifactId>" + "<version>1</version>" +
				...
				"<build>" + "  <resources>" + "    <resource>" + "      <directory>res</directory>" + "      <excludes>" + "        <exclude>**/*</exclude>" + "      </excludes>" + "    </resource>"
				+ "  </resources>" + "</build>");
		importProject();
	...
	public void testDoNotCopyExcludedStandardResources() throws Exception
	{
		...
		consulo.ide.impl.compiler.resourceCompiler.ResourceCompilerConfiguration configuration = ResourceCompilerConfiguration.getInstance(myProject);
		...
		importProject("<groupId>test</groupId>" + "<artifactId>project</artifactId>" + "<version>1</version>" +
				...
				"<build>" + "  <resources>" + "    <resource>" + "      <directory>res</directory>" + "      <includes>" + "        <include>**/*.xxx</include>" + "      </includes>" + "      " +
				"<excludes>" + "        <exclude>**/*.zzz</exclude>" + "      </excludes>" + "    </resource>" + "  </resources>" + "</build>");
	...
	public void testDoNotDeleteFilesFromOtherModulesOutput() throws Exception
	{
		...
		createModulePom("m1", "<groupId>test</groupId>" + "<artifactId>m1</artifactId>" + "<version>1</version>" +
				...
				"<build>" + "  <resources>" + "    <resource>" + "      <directory>resources</directory>" + "    </resource>" + "  </resources>" + "</build>");
	...
	public void testWebResources() throws Exception
	{
		...
		importProject("<groupId>test</groupId>" + "<artifactId>project</artifactId>" + "<version>1</version>" + "<packaging>war</packaging>" +
				...
				"    <webResources>" + "          <directory>res</directory>" + "          <includes>" + "            <include>**/*.properties</include>" + "            <include>**/*.xml</include>"
				+ "          </includes>" + "          <excludes>" + "            <exclude>*.properties</exclude>" + "            <exclude>dir/*.xml</exclude>" + "          </excludes>" + "        " +
	...
	public void testOverridingWebResourceFilters() throws Exception
	{
		...
		createProjectPom("<groupId>test</groupId>" + "<artifactId>project</artifactId>" + "<version>1</version>" + "<packaging>war</packaging>" +
