...
public abstract class MavenProjectsTreeReadingTest extends MavenProjectsTreeTestCase {
  ...
  public void testSendingNotificationsWhenAddingOrDeletingManagedFiles() throws Exception {
    ...
    myTree.addManagedFilesWithProfiles(Collections.singletonList(myProjectPom), new MavenExplicitProfiles(Collections.<String>emptyList()));
    myTree.updateAll(false, getMavenGeneralSettings(), EMPTY_MAVEN_PROCESS);
  ...
  private static class MyLoggingListener extends MavenProjectsTree.ListenerAdapter {
    ...
    private void append(List<MavenProject> updated, String text) {
      ...
      log += StringUtil.join(updated, new consulo.ide.impl.idea.util.Function<MavenProject, String>() {
        @Override
