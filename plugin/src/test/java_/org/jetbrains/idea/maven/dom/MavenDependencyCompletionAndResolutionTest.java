...
public abstract class MavenDependencyCompletionAndResolutionTest extends MavenDomWithIndicesTestCase {
    ...
    public void testChangingExistingProjects() throws Exception {
        ...
        VirtualFile m1 = createModulePom(
            "m1",
            "<groupId>test</groupId>" +
                "<artifactId>m1</artifactId>" +
                "<version>1</version>"
    ...
    public void testRemovingExistingProjects() throws Exception {
        final VirtualFile m = createModulePom(
            "m1",
            "<groupId>project-group</groupId>" +
                "<artifactId>m1</artifactId>" +
                "<version>1</version>"
    ...
    public void testResolutionInsideTheProject() throws Exception {
        ...
        VirtualFile m2 = createModulePom(
            "m2",
            "<groupId>test</groupId>" +
                "<artifactId>m2</artifactId>" +
                "<version>1</version>"
    ...
    public void testChooseFileIntentionForSystemDependency() throws Throwable {
        ...
        try {
            ...
            ((ChooseFileIntentionAction) ((consulo.ide.impl.idea.codeInsight.intention.impl.config.IntentionActionWrapper) action).getDelegate()).setFileChooser(
                null);
        }
