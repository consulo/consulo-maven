...
public class Endpoint {
    public static DataSource getArtifactInfoByUri(String uri)
        ...
        DataSource _retVal = _dsDispatcher.doGET(
            _url,
    ...
    public static class Search {
        ...
        public static class Gavc {
            ...
            public DataSource getGavcSearchResultJson(String g, String a, String v, String c, String repos)
                ...
                String _url = _uriBuilder.buildUri(_templateAndMatrixParameterValues, _queryParameterValues);
                DataSource _retVal =
                    _dsDispatcher.doGET(_url, _headerParameterValues, "application/vnd.org.jfrog.artifactory.search.GavcSearchResult+json");
                return _retVal;
            }
        ...
        public static class Archive {
            ...
            public DataSource getArchiveSearchResultJson(String className, String repos)
                ...
                DataSource _retVal = _dsDispatcher.doGET(
                    _url,
                    _headerParameterValues,
                    "application/vnd.org.jfrog.artifactory.search.ArchiveEntrySearchResult+json"
                );
                return _retVal;
            }
    ...
    public static class System {
        ...
        public static class Configuration {
            ...
            public DataSource postAsTextPlain(DataSource input) throws IOException, MalformedURLException {
                HashMap<String, Object> _queryParameterValues = new HashMap<>();
                HashMap<String, Object> _headerParameterValues = new HashMap<>();
                String _url = _uriBuilder.buildUri(_templateAndMatrixParameterValues, _queryParameterValues);
                DataSource _retVal =
                    _dsDispatcher.doPOST(input, "application/xml", _url, _headerParameterValues, "text/plain");
                return _retVal;
            }
    ...
    public static class SystemVersion {
        ...
        public DataSource getSystemVersionJson() throws IOException, MalformedURLException {
            ...
            String _url = _uriBuilder.buildUri(_templateAndMatrixParameterValues, _queryParameterValues);
            DataSource _retVal =
                _dsDispatcher.doGET(_url, _headerParameterValues, "application/vnd.org.jfrog.artifactory.system.Version+json");
            return _retVal;
        }
    ...
    public static class Repositories {
        ...
        public DataSource getRepositoryDetailsListJson(String type) throws IOException, MalformedURLException {
            HashMap<String, Object> _queryParameterValues = new HashMap<>();
            HashMap<String, Object> _headerParameterValues = new HashMap<>();
