...
public class MavenPropertyResolver {
    ...
    public static void doFilterText(
        Module module,
        String text,
        ...
        doFilterText(
            MavenFilteredPropertyPsiReferenceProvider.getDelimitersPattern(mavenProject),
            manager,
            mavenProject,
            text,
    ...
    private static void doFilterText(
        Pattern pattern,
        ...
        while (matcher.find()) {
            if (escapeString != null) {
                ...
                if (escapeStringStartIndex >= last && text.startsWith(escapeString, escapeStringStartIndex)) {
    ...
    public static String resolve(String text, MavenDomProjectModel projectDom) {
        ...
        try {
            doFilterText(
                ...
                mavenProject,
                text,
                collectPropertiesFromDOM(mavenProject, projectDom),
                null,
                false,
                null,
                res
    ...
    @Nullable
    private static String doResolveProperty(
        String propName,
