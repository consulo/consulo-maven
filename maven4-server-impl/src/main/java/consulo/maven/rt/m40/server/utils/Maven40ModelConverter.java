...
public class Maven40ModelConverter {
  public static MavenModel convertModel(File pomFile, Model model) {
  ...
  public static MavenSource convert(File pomFile, org.apache.maven.api.model.Source it) {
  ...
  public static MavenSource convert(File pomFile, SourceRoot it) {
  ...
  public static List<MavenResource> convertResources(List<Resource> resources) {
    ...
    List<MavenResource> result = new ArrayList<>(resources.size());
  ...
  public static List<MavenRemoteRepository> convertRepositories(List<? extends Repository> repositories) {
    if (repositories == null) return new ArrayList<>();

    List<MavenRemoteRepository> result = new ArrayList<>(repositories.size());
  ...
  private static void doConvert(Object object, String prefix, Map<String, String> result)
    ...
    for (Method each : collectGetters(object.getClass())) {
