...
public class Maven40WorkspaceMapReader implements WorkspaceReader, MavenWorkspaceReader {
  ...
  public List<String> findVersions(Artifact artifact) {
    ...
    Set<MavenId> ids = myWorkspaceMap.getAvailableIds();
    for (MavenId id : ids) {
      if (Objects.equals(id.getArtifactId(), artifact.getArtifactId()) &&
          Objects.equals(id.getGroupId(), artifact.getGroupId())) {
