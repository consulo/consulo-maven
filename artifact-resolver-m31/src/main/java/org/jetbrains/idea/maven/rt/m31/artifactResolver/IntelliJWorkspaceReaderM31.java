 ...
 */
package org.jetbrains.idea.maven.rt.m31.artifactResolver;
...
public class IntelliJWorkspaceReaderM31 implements WorkspaceReader
{
	...
	public File findArtifact(Artifact artifact)
	{
		...
		return MavenModuleMap.getInstance().findArtifact(artifact.getGroupId(), artifact.getArtifactId(), type, artifact.getBaseVersion());
	}
