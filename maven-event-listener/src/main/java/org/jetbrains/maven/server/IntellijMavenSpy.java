...
import consulo.maven.rt.server.common.util.MavenExceptionUtil;
...
public class IntellijMavenSpy extends AbstractEventSpy {
  ...
  private static String getErrorMessage(Exception exception) {
    ...
    Throwable rootCause = MavenExceptionUtil.getRootCause(exception);
    String rootMessage = rootCause != null ? rootCause.getMessage() : "";
    return !MavenStringUtil.isEmptyOrSpaces(rootMessage) ? rootMessage : baseMessage;
  }
